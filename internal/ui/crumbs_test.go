...
func TestNewCrumbs(t *testing.T) {
	...
	assert.Equal(t, "[#000000:#00ffff:b] <c1> [-:#000000:-] [#000000:#00ffff:b] <c2> [-:#000000:-] [#000000:#ffa500:b] <c3> [-:#000000:-] ", v.GetText(false))
}
...
func (c c) GetFocusable() tviewx.Focusable                  { return c }
func (c) PasteHandler() func(string, func(tview.Primitive)) { return nil }
